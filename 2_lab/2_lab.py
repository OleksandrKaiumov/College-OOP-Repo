print("1________________________")
...
print("2________________________")

print("Перша константа: ", True)
print(f"Друга константа {False}")
print(f"Третя константа {None}")

print("3________________________")
...
print("4________________________")
...
print("5________________________")
...
print("6________________________")
...
print("7________________________")

with open("README.md", "r") as f:
    for _, line in enumerate(f):
        print(line.split())

print("8________________________")
...
print("9________________________")
